...
1. We have done benchmarks using EigenExa, ELPA, and Elemental on available platforms, K, JUQUEEN and JURECA and lately on JURECA Booster module and OakForeast-PACS.
1. As JUQUEEN will be put out of operation by end of March 2018 we only completed old benchmarks. The old compiler does not support
C++/11 and the latest Fortran, thus it was not possible to install newer versions of Elemental and ELPA.
 ...
 * EigenExa : 2.4p1
 * ELPA : 2017.11.001 includes support for KNL and GPU, new user interface
 * Elemental: 0.87.7

The following table summarizes the present status:
| HW Platform | ELPA (2017.11) | Elemental (0.87) | EigenExa (2.4p1) |
|:--+:---:+:---:+:---:|
| K | Only 2016.11 | NA [^1] | Hybrid |
| JUQUEEN | Only 2015.11 | Only 0.85 | Only 2.4a(beta) |
| JURECA | Hybrid | Hybrid | Hybrid |
|JURECA booster| Hybrid | not yet | Hybrid |
...
Toshiyuki Imamura participated in the 7th JLESC workshop in UIUC Urbana and
will visit the 8th JLESC workshop in Barcelona. He visited Juelich after ISC17
